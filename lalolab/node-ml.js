...
module.exports = {
    ...
    Linalg: {
        ...
        solve:solve,
        cholsolve:cholsolve,
        solveWithQRfactorization:solveWithQRfactorization,
        backsubstitution:backsubstitution,
        forwardsubstitution:forwardsubstitution,
        solveWithQRcolumnpivoting:solveWithQRcolumnpivoting,
        solveWithQRcolumnpivotingMultipleRHS:solveWithQRcolumnpivotingMultipleRHS,
        solveGaussianElimination:solveGaussianElimination,
        inv:inv,
        chol:chol,
        ldlsymmetricpivoting:ldlsymmetricpivoting,
        house:house,
        qroriginal:qroriginal,
        qr:qr,
        qrRnotTransposed:qrRnotTransposed,
        solvecg:solvecg,
        solvecgdense:solvecgdense,
        cgnr:cgnr,
        cgnrdense:cgnrdense,
        lanczos:lanczos,
        tridiagonalize:tridiagonalize,
        givens:givens,
        premulGivens:premulGivens,
        postmulGivens:postmulGivens,
        implicitSymQRWilkinsonShift:implicitSymQRWilkinsonShift,
        eig:eig,
        eigs:eigs,
        eig_powerIteration:eig_powerIteration,
        eig_orthogonalIteration:eig_orthogonalIteration,
        eig_inverseIteration:eig_inverseIteration,
        eigenvector:eigenvector,
        eig_inverseOrthogonalIteration:eig_inverseOrthogonalIteration,
        eig_bisect:eig_bisect,
        bidiagonalize:bidiagonalize,
        GolubKahanSVDstep:GolubKahanSVDstep,
        svd:svd,
        rank:rank,
        nullspace:nullspace,
        orth:orth,
